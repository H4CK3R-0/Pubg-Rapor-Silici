...
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/ProgramBinaryCache
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTracker/Saved/Config/Android/AntiCheat.ini
rm -rf /storage/emulated/0/MidasOversea/GUID
rm -rf /storage/emulated/0/tencent/Midas/Log/com.tencent.ig/20200201_1.txt
rm -rf /storage/emulated/0/tencent/Midas/Log/com.tencent.ig/MidasLog.mmap

rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTracker/Saved/Config/Android/AntiCheat.ini
echo "Rapor Silici Başlatıldı!

       Çalışıyor

PUBG MOBİLE LOGS & REPORTS SİLİNİYOR"
